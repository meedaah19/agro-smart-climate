  ...
  return (
    ...
    return (
      <div className="lg:w-[1440px] w-full h-auto lg:h-[1100px] flex lg:gap-[32px] bg-gradient-to-b from-[#A9DCD7] pb-[0px] via-[#FFFFFF] to-[#A9DCD7]">
        ...
        <div className='lg:w-[1150px] relative lg:z-100 h-auto w-[320px] lg:h-[1024px] py-[32px] flex flex-col gap-[12px]'>
          <h4 className='font-[Poppins] font-[400] text-[23.04px]'>My profile</h4>

          <div className='relative z-[60] lg:w-[1020px] w-full h-auto lg:h-[1000px] rounded-[30px] p-[32px] flex flex-col gap-[32px] bg-[#FFFFFF]'>
