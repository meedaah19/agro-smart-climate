...
//                     <div className='lg:w-[980px] w-full h-auto  flex justify-between'>
...
//                                     alt="profile picture" 
//                                 />
//                                 <FaCamera className="absolute bottom-1 right-1 text-black p-1 rounded-full text-2xl pointer-events-none" />
//                              </div>

//                             <div className=' flex gap-2'>
//                                <button
//                                onClick={handleClick}
//                                className='text-[16px] font-[500] font-[Lora] cursor-pointer'>Edit Profile</button>
//                                 <FaEdit/>
//                             </div>
//                         </div>
