...
export default function Layout5(){
    ...
    return(
        <div className="w-full max-w-[1440px] h-auto lg:h-[724px] lg:pr-[160px] lg:pl-[160px] pl-[30px] pr-[30px] bg-gradient-to-b from-[#C6E4E1] via-[#E3F1F0] to-[#FFFFFF] lg:pt-[80px] lg:pb-[80px] pt-[30px] pb-[30px] flex lg:gap-[10px]">

            <div className=" lg:w-[1220px] h-auto lg:h-[564px] lg:flex  lg:gap-[32px] ">

                <div className="lg:w-[588px]   h-auto lg:h-[564px] ">
                    <h1 className="font-[Poppins] font-[600] text-[28px] lg:text-[39.81px]  ">Testimonials</h1>
                    <p className="font-[Poppins] font-[400] text-[20px] lg:text-[27.65px] pt-8 lg:pb-0 pb-4">
