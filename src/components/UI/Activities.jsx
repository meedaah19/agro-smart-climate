...
export default function Activities({image, period, location, list1, list2, list3, list4, list5, alt}){
    ...
    return(
        <div className="lg:w-[469px] w-full  h-auto lg:h-[380px] rounded-[30px] py-[16px] px-[32px] grid gap-[16px] bg-[#FFFFFF] shadow-2xl ">

            <div className="lg:w-[405px] w-full h-auto lg:h-[155px] flex lg:flex-row flex-col gap-[16px]"> 
                ...
                <div className="w-[160px] h-auto lg:h-[155px] grid gap-[8px] ">
                    ...
                    <div className="lg:w-[160px] w-full h-auto lg:h-[92px] flex flex-col gap-4 lg:gap-0 justify-between">
                        <div className="flex gap-[10px]">
                            <FaLocationDot className="h-8"/>
                            <p className="font-[Lora] font-[400] text-[13px]">{location}</p>
                        </div>
                        <div className="bg-[#FF8E28]  lg:w-[160px] w-full h-auto lg:h-[38px] rounded-[8px] py-[8px] px-[16px] text-[16px] font-[700] font-[Lora] ">
                            <p>Weather report</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:w-[405] w-full h-auto lg:h-[189px]">
                ...
                <div className="lg:w-[405px] w-full h-auto lg:h-[160px] font-[600] font-[Lora] text-[16px] list-decimal" >
                    <li>{list1}</li>
                    <li>{list2}</li>
                    <li>{list3}</li>
                    <li>{list4}</li>
